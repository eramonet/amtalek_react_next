...
export default function ButtonNavbar() {
  ...
  return (
    <div className="flex items-center justify-center gap-10">
      ...
      <Link
        href="/coming-soon"
        className="text-white rounded h-10 flex justify-center items-center gap-2 px-2 sm:px-3 py-[6px] bg-red-500 transition-all duration-300 ease-in-out  hover:bg-transparent hover:text-red-500 text-bg text-md border-2 border-red-500"
      >
        <TbSocial />
