...
//       formData.append("image_key", "main");
//       formData.append("created_from", "web");

//       await fetch(process.env.NEXT_PUBLIC_USER_PROFILE_UPDATE_IMG, {
//         method: "POST",
//         body: formData,
//         headers: {
//           Authorization: `Bearer ${usertoken}`,
...
//       // Fetch the updated data after updating the image
//       await fetchData(); // Re-fetch data after the image update
//     } catch (error) {
